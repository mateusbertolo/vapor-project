...
<div id="content-container">
    ...
    <div id="list-container">
        ...
        <table>
            ...
            <?php while ($plataforma = mysqli_fetch_array($plataformas)) { ?>
                ...
                <tr>
                    ...
                    <td class="center"><a href="excluir-plataforma-jogos.php?id_plataforma=<?= $plataforma['id']?>&id_jogo=<?=$id_jogo?>">Excluir</a></td>
                </tr>
       ...
       <?php if($plataformas->num_rows == 0) { ?>
            <h1>Esse jogo não Possui Plataformas cadastradas <?=$jogo['nome']?></h1>
        <?php }  ?>
